...
<div class="row top-b">
  <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
    ...
    <input type="text"  value=" " name="im" size="3" class="form-control" disabled ></div>
...
<div class="row top-b">
  ...
  <input type="text" class="data form-control"	value="<?php echo implode("/",array_reverse(explode("-",$dataHora))); ?>" name="data_venc" >
</div>
<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" >
  
<label>
Data Pagamento :</label> <input type="text" class="data form-control" value="<?php echo implode("/",array_reverse(explode("-",$dataHora))); ?>" name="data_efe" >
...
<?php echo form_dropdown('tipo_pag', $pag, '0','class="form-control"'); ?>
</div>
<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
...
<?php echo form_dropdown('tipo_doc', $t_doc, '0','class="form-control"'); ?>
</div>
...
<input type="text"  value=""  class="form-control" name="n_ope_cli" > 

  </div>
  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
    
<label>
parcela :</label> <input type="text"  class="form-control" value="" name="parcela" >
...
<label>
numero conta:</label> 
<?php echo form_dropdown('n_conta', $bancos, '0','class="form-control"'); ?>
</div>
...
<label>Cedente :</label> 
<?php echo form_dropdown('n_cedente', $fornecedor,"0",'class="form-control"'); ?>
</div></div>
...
<label>
situacao :</label> 
<?php echo form_dropdown('situacao', $status,"0" ,'class="form-control"'); ?>
</div>


  <div class="col-md-6">
<label>d_desp:</label> 
<?php echo form_dropdown('d_desp', $d_desp, '0','class="form-control"'); ?>
 </div></div>
